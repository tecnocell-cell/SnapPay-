...
export const REGISTRY = [
  ...
  { id: "tabelaspreco", modulo: "produtos", label: "Tabelas de Preço", icon: "🏷️", perm: "produtos.ver" },
  { id: "promocoes", modulo: "produtos", label: "Promoções", icon: "🎁", perm: "produtos.ver" },
  { id: "lojas", modulo: "estoque", label: "Lojas/Unidades", icon: "🏬", perm: "estoque.editar" },
